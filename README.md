...
.forEach will return nothing while .Map will return a new array.

2. What is the difference between a function and a method?

a function is not associated with code while a method is

3. What is closure?

a closure is when an inside function can access the function of the variable on the outside
...
it allows access th the this item.
